        ...
        <section className='mission' id='mission'>
            <div className="container">
                ...
                <div className="card my-5">
                    <div className="card-container">
                        ...
                        <div className="description ">
                            <div className="head fw-bold fs-28 green text-decoration-underline">Mission</div>
                ...
                <div className="card">
                    <div className="card-container">
                        <div className="description ">
                            <div className="head fw-bold fs-28 green text-decoration-underline">Vision</div>
                            <div className="miss-body">
